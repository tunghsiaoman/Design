package com.design.dao.mybatis;
...
import com.design.dao.asyn.AsyncMapperExecutor;
    ...
    private void processPropertyPlaceHolders() {
        ...
        if (!prcs.isEmpty() && applicationContext instanceof GenericApplicationContext) {
            BeanDefinition mapperScannerBean =
                    ((GenericApplicationContext) applicationContext).getBeanFactory().getBeanDefinition(beanName);
